...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	    ...
	    if (HAL_GPIO_ReadPin(switch1_GPIO_Port, switch1_Pin) == GPIO_PIN_RESET) // Assuming active-low switch
	    {
	      ...
	      while (HAL_GPIO_ReadPin(switch1_GPIO_Port, switch1_Pin) == GPIO_PIN_RESET);
